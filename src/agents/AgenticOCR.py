...
from src.agents.MinerUTool import ImageZoomOCRTool, TOOL_CALL_RE, local_image_to_data_url
...
if __name__ == "__main__":
    ...
    agent = AgenticOCR(
        ...
        model_name="/path/to/AgenticOCR-checkpoint",
        tool=ImageZoomOCRTool(work_dir="/path/to/work_dir"),
        max_image_size=2048 # Limit longest edge to 2048px
    )
    
    file_path = "/path/to/finragbench_bbox_test.json"
